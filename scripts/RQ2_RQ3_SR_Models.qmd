...
fact is what is most salient. This is not a particularly large effect and both
models suggest that that it could be either strong enough to matter or so weak
as to be of negligible practical importance. The point estimates lean more
toward the former possibility, but sampling error leaves room for the latter one
too.
:::
...
there's more similarity between the two results than implied by the overly 

...
data on all the measures used in the stopping-ratio models. The 
...
We use the `StartedDT_Applicants` dataset to answer the part of RQ2 pertaining 
to specific training modules because we need to narrow our focus to the subset 
of `Enrolled_Applicants_CD` containing only enrolled applicants with 
...
suitable for use in the stopping-ratio models. The start and finish rates for 

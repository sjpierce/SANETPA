...
:::{.callout-caution}
We need to create centered forms of the continuous predictors that we'll use in 
modeling because we expect to test interaction terms involving them. However, 
I need to move the code for doing this into the modeling script because we'll 
have to handle missing data via listwise deletion. Centering should occur after 

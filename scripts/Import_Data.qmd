...
Threshold_Labels <- c("T1 (Eligible/Started DT)" = 1,
                      "T2 (Started DT/Finished DT)" = 3,
                      "T3 (Finished DT/Finished CSW)" = 4)
```
...
stopped cases were those who did not start didactic training. `T1` to `T3` each 
...
tibble(DataFrame = c("Applicants", "Eligible_Applicants", 
                     "Eligible_Applicants_CD", "T1", "T2", "T3", "Thresholds"),

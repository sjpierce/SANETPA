...
analyses by applying more convenient naming conventions, converting variables . 
...
Applicants <- Applicants_Raw %>% 
  rename(Education - Educ_dem_num,
         ...
         Recruitment = recruitment_num,
         Previous_SANE = prevSANEtrain_num,
         ...
         LGBTQ = LGBTQ_num,
         Plans_Following_Training = PlansFollowingTraining_Num,
         ...
         CSW_Sat1 = cswsat1_numeric,
         CSW_Sat2 = cswsat2_numeric,
         CSW_Sat3 = cswsat3_numeric,
         CSW_Sat4 = cswsat4_numeric,
         CSW_Sat5 = cswsat5_numeric,
         CSW_Sat6 = cswsat6_numeric,
         CSW_Sat7 = cswsat7_numeric,
         CSW_Finished = finishedCSW,
         Didactic_Finished = finisheddidac,
         ...
         Mod1_Started = Mod1_started,
         Mod1_Finished = Mod1_finished,
         Mod2_Started = Mod2_started,
         Mod2_Finished = Mod2_finished,
         Mod3_Started = Mod3_started,
         Mod3_Finished = Mod3_finished,
         Mod4_Started = Mod4_started,
         Mod4_Finished = Mod4_finished,
         Mod5_Started = Mod5_started,
         Mod5_Finished = Mod5_finished,
         Mod6_Started = Mod6_started,
         Mod6_Finished = Mod6_finished,
         Mod7_Started = Mod7_started,
         Mod7_Finished = Mod7_finished,
         Mod8_Started = Mod8_started,
         Mod8_Finished = Mod8_finished,
         Mod9_Started = Mod9_started,
         Mod9_Finished = Mod9_finished,
         Mod10_Started = Mod10_started,
         Mod10_Finished = Mod10_finished,
         Mod11_Started = Mod11_started,
         Mod11_Finished = Mod11_finished,
         Mod12_Started = Mod12_started,
         Mod12_Finished = Mod12_finished,
         Mod1_SDate = Mod1Start,
         Mod2_SDate = Mod2Start,
         Mod3_SDate = Mod3Start,
         Mod4_SDate = Mod4Start,
         Mod5_SDate = Mod5Start,
         Mod6_SDate = Mod6Start,
         Mod7_SDate = Mod7Start,
         Mod8_SDate = Mod8Start,
         Mod9_SDate = Mod9Start,
         Mod10_SDate = Mod10Start,
         Mod11_SDate = Mod11Start,
         Mod12_SDate = Mod12Start)
...
## Create Person-Stage Dataset
To run the planned continuation-ratio model, we need to reorganize the data from 
one row per person, to one row per person per stage attempted. This is similar 
to the person-period form of organizing longitudinal data for use in growth 
curve models implemented as mixed models. 

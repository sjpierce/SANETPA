...
R1S [label = "RQ1_Analyses.qmd\n(Quarto Script)"]
R1O [label = "RQ1_Analyses_YYYY-MM-DD.pdf\n(PDF Output)", fillcolor = "grey80"]
R2S [label = "RQ2_RQ3_SR_Models.qmd\n(Quarto Script)"]
R2O [label = "RQ2_RQ3_SR_Models_YYYY-MM-DD.pdf\n(PDF Output)", fillcolor = "grey80"]
R4S [label = "RQ4_Analyses.qmd\n(Quarto Script)"]
R4O [label = "RQ4_Analyses_YYYY-MM-DD.pdf\n(PDF Output)", fillcolor = "grey80"]
F2O [label = "Campbell_Figure_2_YYYY-MM-DD.tif\n(TIFF Output)", fillcolor = "grey80"]
EDS [label = "Export_Diagram.qmd\n(Quarto Script)"]
F1bO [label = "Campbell_Figure_1_YYYY-MM-DD.tif\n(TIFF Output)", fillcolor = "grey80"]
EDO [label = "Export_Diagram_YYYY-MM-DD.pdf\n(PDF Output)", fillcolor = "grey80"]
F1aO [label = "Campbell_Figure_1_YYYY-MM-DD.png\n(PNG Output)", fillcolor = "grey80"]
IDS [label = "Import_Data.qmd\n(Quarto Script)"]
RawData [label = "All_group_1_2025-11-19.sav\n(SPSS Data File)", fillcolor = "white"]
...
PRS -> EDS [label = "Custom Render"]
PRS -> IDS [label = "Custom Render"]
PRS -> DAS [taillabel = "Custom Render"]
PRS -> R1S [taillabel = "Custom Render"]
PRS -> R2S [taillabel = "Custom Render"]
PRS -> R4S [taillabel = "Custom Render"]
...
FinalData -> R1S [label = "Read"]
FinalData -> R2S [label = "Read"]
FinalData -> R4S [label = "Read"]
R1S -> R1O [label = "Renders"]
R2S -> R2O [label = "Renders"]
R4S -> R4O [label = "Renders"]
R4S -> F2O [label = "Exports"]
EDS -> EDO [label = "Renders"]
EDS -> F1aO [label = "Exports"]
EDS -> F1bO [label = "Exports"]
F1aO -> F1bO [label = "Convert"]

{ rank=same; EDS; IDS; FinalData; DAS; R1S; R2S; R4S}
{ rank=same; F1aO; F1bO; EDO; IDO; DAO; R1O; R2O; R4O, F2O}
...
:::{.callout-caution} 
Whenever the `scripts/Import_Data.qmd` script is rendered (either in draft or 
production runs), it will overwrite the `data/Imported_SANETP_Data.RData` file. 
Rename that data file before you render the script if you want to preserve the
version of it that is distributed with the repository. Alternatively, you can
download the original file from GitHub again.
:::
...
## RQ1 Analyses
Work on this script is complete. 
...
OutFile <- paste0("RQ1_Analyses_", Sys.Date(), ".pdf")

# Render the script in a fresh R session.
quarto_render(input = here::here("scripts/RQ1_Analyses.qmd"), 
              output_format = "pdf",
              output_file = OutFile, 
              execute_params = list(SourceDir = params$SourceDir, 
                                    SourceFile = "RQ1_Analyses.qmd", 
                                    LogFile = OutFile),
              execute_dir = here::here("scripts"),
              as_job = "auto", 
              quarto_args = c('--output', OutFile))
...
## RQ2 and RQ3 Stopping-Ratio Models
Work on this script is complete. 
...
OutFile <- paste0("RQ2_RQ3_SR_Models_", Sys.Date(), ".pdf")

# Render the script in a fresh R session.
quarto_render(input = here::here("scripts/RQ2_RQ3_SR_Models.qmd"), 
              output_format = "pdf",
              output_file = OutFile, 
              execute_params = list(SourceDir = params$SourceDir, 
                                    SourceFile = "RQ2_RQ3_SR_Models.qmd", 
                                    LogFile = OutFile),
              execute_dir = here::here("scripts"),
              as_job = "auto", 
              quarto_args = c('--output', OutFile))
...
OutFile <- paste0("RQ4_Analyses_", Sys.Date(), ".pdf")

# Render the script in a fresh R session.
quarto_render(input = here::here("scripts/RQ4_Analyses.qmd"), 
              output_format = "pdf",
              output_file = OutFile, 
              execute_params = list(SourceDir = params$SourceDir, 
                                    SourceFile = "RQ4_Analyses.qmd", 
                                    LogFile = OutFile),
              execute_dir = here::here("scripts"),
              as_job = "auto", 
              quarto_args = c('--output', OutFile))
...
OutFile <- paste0("Export_Diagram_", Sys.Date(), ".pdf")

# Render the script in a fresh R session.
quarto_render(input = here::here("scripts/Export_Diagram.qmd"), 
              output_format = "pdf",
              output_file = OutFile, 
              execute_params = list(SourceDir = params$SourceDir, 
                                    SourceFile = "Export_Diagram.qmd", 
                                    LogFile = OutFile),
              execute_dir = here::here("scripts"),
              as_job = "auto", 
              quarto_args = c('--output', OutFile))

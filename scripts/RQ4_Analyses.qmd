...
For RQ4, we need two additional subsets of the data. We create the new scale 
score variables measuring training satisfaction (`DT_Satisfaction` and 
`CSW_Satisfaction`) while creating those datasets. 

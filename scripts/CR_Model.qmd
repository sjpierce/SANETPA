...
continuation-ratio models that comprise the main analysis for the study. This
...
* **RQ2.** How much do the following factors predict attrition rates at each 
  those four thresholds? 
    * Whether the trainee practices nursing in a rural area.
    * Whether the trainee perceives a lack of other local resources for 
      survivors of sexual assault.
    * Whether the trainee has a personal connection to the issue of sexual 
      assault. 
    * Whether there are other outside demands on a trainee's time.
    * The trainee's level of exposure to vicarious trauma. 
...
handled via continuation-ratio models. Research questions RQ4 and RQ5 will be 
...
# Overview of Continuation-Ratio Modeling {#sec-CR-Modeling}

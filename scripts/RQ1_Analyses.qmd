...
CI and the p-values fell just above versus below the $\alpha = 0.05$ cutoff, but
the CIs show that nearly all plausible values for the differences in proportions
are consistent with the interpretation above.
...
be anywhere from trivially small to medium. We did firmly establish the presence 
or direction an effect of enrollment status on mean levels of work 

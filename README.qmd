...
version 2025.09.1+401 (or later). We recommend using RStudio to interact with
...
like the following command in the Terminal after changing to the `scripts/` 
folder. Just update the date in the output filename to match the current date.
